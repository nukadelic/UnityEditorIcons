...
public class EditorIcons : EditorWindow
{
    ...
    bool needsConsoleClear = false;
    static GUIContent iconSelected;
    GUIStyle iconBtnStyle = null;
    ...
    void InitIcons()
    {
        ...
        for (var i = 0; i < ico_list.Length; ++i)
        {
            ...
            try { ico = EditorGUIUtility.IconContent(ico_list[i]); }
            catch (System.Exception _ ) { iconMissingNames.Add(ico_list[i]); }

            if( ico == null || ico.image == null ) continue;

            ico.tooltip = ico_list[i];

            iconContentListAll.Add(ico);
            
            if (ico.image.width > 32 || ico.image.height > 32)
    ...
    public static readonly string[] ico_list = 
    {
        "_Help",
        "_Popup",
